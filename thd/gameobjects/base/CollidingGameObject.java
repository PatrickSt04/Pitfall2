...
public abstract class CollidingGameObject extends GameObject {
    ...
    /**
     * Decides whether an object is allowed to move.
     * If they are out of screen they should stop to move.
     *
     * @return boolean
     */
    public boolean allowedToUpdatePosition() {
        return position.getX() > 0 && position.getY() > 0 && position.getX() < GameView.WIDTH && position.getY() < GameView.HEIGHT;
    }
